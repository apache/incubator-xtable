...
public class TestParquetSchemaExtractor {
 ...
 /*       Assertions.assertEquals(
        ...
        Map<InternalSchema.MetadataKey, Object> millisMetadata= Collections.singletonMap(InternalSchema.MetadataKey.TIMESTAMP_PRECISION,InternalSchema.MetadataValue.MILLIS);
        Map<InternalSchema.MetadataKey, Object> microsMetadata = Collections.singletonMap(InternalSchema.MetadataKey.TIMESTAMP_PRECISION,InternalSchema.MetadataValue.MICROS);
        Map<InternalSchema.MetadataKey, Object> nanosMetadata = Collections.singletonMap(InternalSchema.MetadataKey.TIMESTAMP_PRECISION,InternalSchema.MetadataValue.NANOS);
