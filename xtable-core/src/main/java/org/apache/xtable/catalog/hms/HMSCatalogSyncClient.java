...
import org.apache.xtable.catalog.CatalogTableBuilderFactory;
...
public class HMSCatalogSyncClient implements CatalogSyncClient<Table> {
  ...
  private final CatalogTableBuilder<Table> tableBuilder;
  ...
  public HMSCatalogSyncClient(
    ...
    this.tableBuilder = CatalogTableBuilderFactory.getHmsCatalogTableBuilder(tableFormat, configuration, schemaExtractor);
  }
  ...
  HMSCatalogSyncClient(
      ...
      CatalogTableBuilder<Table> tableBuilder) {
    this.catalogConfig = catalogConfig;
