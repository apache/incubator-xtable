...

{
  ...
  // Keep this list resolving to the same artifacts as the coursier fetch in
  // prefetch_dependencies.sh; a divergence means a network resolve on every
  // kernel start instead of a cache hit.
  Seq(
    ("org.apache.logging.log4j", "log4j-api", xtableVersion("log4j.version")),
    ("org.apache.logging.log4j", "log4j-core", xtableVersion("log4j.version")),
    ...
    ("io.trino", "trino-jdbc", xtableVersion("trino.jdbc.version")),
    ("com.facebook.presto", "presto-jdbc", xtableVersion("presto.jdbc.version"))
