...
rsync -a \
  ...
  --exclude "assets" --exclude "demo" --exclude "website" --exclude "style" . xtable-$RELEASE_VERSION

tar czf ${RELEASE_DIR}/xtable-${RELEASE_VERSION}.src.tgz xtable-$RELEASE_VERSION
gpg --armor --local-user E391B3E8179C4FD9BB8BF72002AB8E945EFD1E91 --detach-sig ${RELEASE_DIR}/xtable-${RELEASE_VERSION}.src.tgz
cd ${RELEASE_DIR}
shasum -a 512 xtable-${RELEASE_VERSION}.src.tgz > xtable-${RELEASE_VERSION}.src.tgz.sha512
